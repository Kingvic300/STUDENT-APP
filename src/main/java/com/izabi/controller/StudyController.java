...
public class StudyController {
    ...
    public ResponseEntity<StudyMaterialResponse> generateStudyMaterial(@RequestParam("file") MultipartFile file) {
        ...
        try {
            StudyMaterialResponse studyMaterial = studyAppService.generateStudyMaterial(file);
